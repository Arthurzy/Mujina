...
public class MetadataController {
    ...
    public String metadata(@Value("${idp.base_url}") String idpBaseUrl) throws SecurityException,
            ParserConfigurationException, SignatureException, MarshallingException, TransformerException {
        ...
        Credential credential = keyManager
                .resolveSingle(new CriteriaSet(new EntityIDCriteria(idpConfiguration.getEntityId())));
